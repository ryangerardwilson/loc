...
class InstallContractTests(unittest.TestCase):
    ...
    def test_version_without_argument_prints_latest_release(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self._write_executable(
                ...
                "  printf 'https://github.com/ryangerardwilson/loc/releases/tag/v0.1.21\\n'\n"
                "  exit 0\n"
                "fi\n"
    ...
    def test_upgrade_same_version_uses_version(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertTrue((Path('$HOME/.local/bin'.replace("$HOME", str(home_dir))) / 'loc').exists())
